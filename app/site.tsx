...
export default function TarteeebSite(){
  ...
  return <main>
    ...
    <section id="about" className="section about"><div className="about-motion" aria-hidden="true"><img src="/images/kitchen-organized.jpg" alt=""/><img src="/images/closet-organized.jpg" alt=""/><img src="/images/storage-organized.jpg" alt=""/></div><div className="about-copy"><p className="eyebrow">عن ترتيب</p><h2>نرتب باحترام وخصوصية.</h2><p>فريق سعودي مدرّب يعمل بإشراف واضح، دون أحكام أو تصوير بلا موافقة.</p><div className="commitment"><strong>متابعة بعد التسليم</strong><span>نعود إليك بعد أسبوعين للتأكد من سهولة النظام.</span></div></div></section>
